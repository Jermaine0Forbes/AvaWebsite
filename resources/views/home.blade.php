...
@section('main')
    ...
    <section id="home-block-3" >
        <div class="row  justify-content-center fluid-max-wide-10 center hidden-xs-down">
            <div class="col-2 col-sm-3 col-md-1">
                <img class="img-fluid" src="https://via.placeholder.com/90x90" alt="">
            </div>
            <div class="col-2 col-sm-3 col-md-1">
                <img class="img-fluid" src="https://via.placeholder.com/90x90" alt="">
            </div>
            ...
            <div class="col-md-6">
                <div class="row pad-half-all">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="comments">
                            <span class="fa fa-comment-o"></span> 0 comments
                        </div>
                    </div>
                </div>
            </div>
